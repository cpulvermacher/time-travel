...
- Confirm with Enter or by clicking the apply button, which shows a preview of the change to apply (e.g. "Change date to Apr 27, 2025 12:40"). When first activating the extension on a tab, the page needs to be reloaded once to apply the changes.
