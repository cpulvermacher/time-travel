Falsifie la date, l'heure et le fuseau horaire actuel dans les objets JavaScript Date, Intl.DateTimeFormat ou Temporal.
...
Si vous avez des idées, des rapports de bogues, ou si vous souhaitez contribuer à améliorer Time Travel, veuillez ouvrir une issue sur [GitHub](https://github.com/cpulvermacher/time-travel).
